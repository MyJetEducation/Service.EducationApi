...
using Service.WalletApi.EducationPersonalApi.Modules;

namespace Service.WalletApi.EducationPersonalApi
{
	public class Startup
	{
		...
		{
			StartupUtils.SetupWalletApplication(app, env, Program.Settings.EnableApiTrace, "education/personal");
